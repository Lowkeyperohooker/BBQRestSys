...
<template>
  ...
  >
    ...
    <nav :class="['flex-1 px-4 py-4 space-y-1 overflow-y-auto pb-24 md:pb-6', fontBase]">
      ...
      <router-link v-if="hasAccess(['Admin'])" to="/schedule" class="flex items-center gap-3 px-4 py-3 rounded-lg transition-colors text-gray-400 hover:bg-gray-800 hover:text-white" active-class="bg-blue-600 text-white shadow-md">
