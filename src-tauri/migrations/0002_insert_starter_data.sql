...
('Chicken', 'Thigh', 12.0, 3.0); -- Added Chicken Thigh

-- Note: photo_url will default to NULL since we omit it here
INSERT INTO prepared_inventory (raw_item_id, category, pos_display_name, variant_group, variant_name, current_stock_pieces, unit_price, is_variable_price) VALUES
((SELECT raw_item_id FROM raw_inventory WHERE category = 'Pork' AND specific_part = 'Pork Belly' LIMIT 1), 'Skewered', 'Pork BBQ', NULL, NULL, 150, 35.00, FALSE),
((SELECT raw_item_id FROM raw_inventory WHERE category = 'Chicken' AND specific_part = 'Intestines' LIMIT 1), 'Skewered', 'Chicken Isaw', NULL, NULL, 200, 15.00, FALSE),
((SELECT raw_item_id FROM raw_inventory WHERE category = 'Pork' AND specific_part = 'Intestines' LIMIT 1), 'Skewered', 'Pork Isaw', NULL, NULL, 180, 15.00, FALSE),
((SELECT raw_item_id FROM raw_inventory WHERE category = 'Chicken' AND specific_part = 'Feet' LIMIT 1), 'Skewered', 'Adidas (Chicken Feet)', NULL, NULL, 60, 20.00, FALSE),
((SELECT raw_item_id FROM raw_inventory WHERE category = 'Pork' AND specific_part = 'Ears' LIMIT 1), 'Skewered', 'Tenga (Pork Ears)', NULL, NULL, 45, 20.00, FALSE),

-- VARIANT EXAMPLES: Chicken Thighs
((SELECT raw_item_id FROM raw_inventory WHERE category = 'Chicken' AND specific_part = 'Thigh' LIMIT 1), 'Skewered', 'Small Chicken Thigh', 'Chicken Thigh', 'Small', 30, 45.00, FALSE),
((SELECT raw_item_id FROM raw_inventory WHERE category = 'Chicken' AND specific_part = 'Thigh' LIMIT 1), 'Skewered', 'Large Chicken Thigh', 'Chicken Thigh', 'Large', 20, 65.00, FALSE),

-- VARIANT EXAMPLES: Sodas
(NULL, 'Beverages', 'Coke (8oz)', 'Soda (8oz)', 'Coke', 100, 20.00, FALSE),
(NULL, 'Beverages', 'Sprite (8oz)', 'Soda (8oz)', 'Sprite', 50, 20.00, FALSE),
(NULL, 'Beverages', 'Royal (8oz)', 'Soda (8oz)', 'Royal', 40, 20.00, FALSE),

(NULL, 'Beverages', 'San Miguel Pale Pilsen', NULL, NULL, 48, 60.00, FALSE),
(NULL, 'Desserts', 'Leche Flan', NULL, NULL, 20, 50.00, FALSE),
(NULL, 'Extras', 'Extra Rice', NULL, NULL, 500, 20.00, FALSE);
